  ...
  <form name="case" method="post" action="index.php?r=1">
	...
	<input type="checkbox" name="case2" value="2">ULB Culture<br />
	<input type="checkbox" name="case3" value="3">Service Social<br />
	<input type="checkbox" name="case4" value="4">ULB Sports<br />
	<input type="checkbox" name="case5" value="5">Inscriptions<br /><br />
